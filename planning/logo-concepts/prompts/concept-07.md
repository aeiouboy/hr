...
Subject: A central person-icon (simplified circle head + torso shape) surrounded by an orbital/ring path on which four to six smaller diverse person-icons are placed at intervals — suggesting collaboration, constellation of employees, or 360-degree experience.

Style: Flat vector illustration, structured but warm, modern enterprise SaaS. Logo-mark quality.

Color palette: central figure in warm amber (#F4A261). Orbit ring line in soft gold (#E9C46A). Surrounding smaller figures alternating in peach (#FFB4A2), coral (#FF8A80), sage green (#A3B18A), warm teal (#2A9D8F). Absolutely NO red.

Composition: radial symmetry around center, logo centered with 15% whitespace margin, no text, no tagline, clean white background, readable at 64x64.
