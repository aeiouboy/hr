...
Subject: A warm rising sun where the rays radiating outward are simplified human figure silhouettes instead of straight lines. Center is a solid circle (the sun body). Six to eight people-rays arranged radially.

Style: Flat vector illustration, warm and optimistic, modern enterprise SaaS. Logo-mark quality.

Color palette: sun body in warm amber (#F4A261) to soft gold (#E9C46A) gradient. People-rays in peach (#FFB4A2), coral (#FF8A80), and sage green (#A3B18A) alternating. Absolutely NO red, NO crimson.

Composition: radial symmetry, logo sits perfectly centered with 15% whitespace margin, no text, no tagline, pure white background, readable at 64x64.
