...
Subject: A heart shape formed by two abstract people silhouettes embracing — their curved backs create the two humps of the heart, their feet meet at the bottom point. Heads as small filled circles at the top of each hump.

Style: Flat vector illustration, warm and empathetic, modern enterprise SaaS. Logo-mark quality. Avoid any red-heart cliche by using non-red palette strictly.

Color palette: heart silhouettes in warm coral (#FF8A80) and peach (#FFB4A2) — warm but NOT red. Alternative: one silhouette in warm teal (#2A9D8F) and other in amber (#F4A261) for contrast. Absolutely NO red (#FF0000 range), NO crimson.

Composition: symmetrical heart form, centered with 15% whitespace margin, no text, no tagline, pure white background, readable at 64x64 favicon size.
