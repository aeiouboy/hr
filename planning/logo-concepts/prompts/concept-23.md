Minimalist product logo, square 1:1, white background, centered composition.

Subject: A single lowercase or capital letter "h" drawn as if done in one confident signature-style brush/pen stroke — with a flowing ligature tail that loops back or extends with calligraphic flourish. The letter suggests personal touch, handwritten authenticity, human signature-quality warmth in a tech product. One subtle colored dot or accent at the end of the stroke (suggesting the "dot" of a pen-finished signature).

Style: Flat vector illustration, minimalist calligraphic, modern premium enterprise SaaS with personal-touch DNA. Logo-mark quality suitable for favicon.

Color palette: primary stroke in deep charcoal (#1F2937) OR very dark navy (#111827). Single accent dot at stroke terminus in bright teal (#14B8A6) OR warm amber (#F59E0B) — pick one. Optional very faint drop shadow beneath stroke in 5% opacity gray. Monochrome-feel overall. Absolutely NO red.

Composition: signature H centered, sized to fill 70% of canvas vertically, 15% whitespace margin, no text, no tagline, pure white background, readable at 64x64 favicon.
