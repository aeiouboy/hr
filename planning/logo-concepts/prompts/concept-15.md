...
Subject: A retail price-tag silhouette (rectangular tag with the classic angled cut on the top-left corner, a small circular punch-hole, and a string/loop) sits at an upward tilt angle. Inside the tag sits a clean abstract person-icon (head circle + shoulders) with a small check-mark or plus dot next to it. Suggests: tagged/matched right person, HR decisions tagged like retail SKUs but human-centric.

Style: Flat vector illustration, modern retail-tech SaaS, playful but professional. Logo-mark quality with clear retail DNA and HR people-focus.

Color palette: price-tag body in warm teal (#2A9D8F) with soft gold (#E9C46A) string. Person-icon inside in warm amber (#F4A261). Check-mark in peach (#FFB4A2). Absolutely NO red, NO crimson.

Composition: tag tilted slightly (10-15 degrees), logo centered with 15% whitespace margin, no text, no tagline, pure white background, readable at 64x64.
