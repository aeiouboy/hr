...
Subject: A pair of cupped hands (simplified, palm-up, curved like a gentle bowl) holding a small sprouting seedling at center — two young leaves on a thin stem rising from the palms. The hands and sprout together form an upward-opening organic shape. Suggests nurture, growth, talent development, HR caring for people.

Style: Flat vector illustration, minimalist organic, modern enterprise SaaS. Warm+cool balance, friendly but dignified. Logo-mark quality.

Color palette: hands in deep emerald green (#10B981) fading to soft sage (#A3B18A). Seedling leaves in bright lime (#84CC16). Stem in warm cream (#FEF3C7). Background accent can use ivory (#FFFBEB). Absolutely NO red, NO crimson, NO burgundy.

Composition: hands centered, sprout rising vertically, 15% whitespace margin, no text, no tagline, clean white background, readable at 64x64 favicon.
