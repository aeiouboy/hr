...
Subject: Three concentric circles (like a radar scope or data ring) with 4 small person-icon dots (head+shoulder silhouettes) placed evenly on the outer ring. One slightly larger person-icon sits at the exact center. Faint subtle node-dots on the middle ring to suggest data points. Evokes: 360-degree HR analytics, people at the center of data.

Style: Flat vector illustration, tech-modern data visualization aesthetic but warm (not cold blue). Enterprise SaaS with clear data-driven feel. Logo-mark quality.

Color palette: concentric ring strokes in warm teal (#2A9D8F) with decreasing opacity outward. Center person in warm amber (#F4A261). Outer person-icons alternating peach (#FFB4A2), coral (#FF8A80), sage green (#A3B18A), soft gold (#E9C46A). Absolutely NO red.

Composition: perfect radial symmetry, logo centered with 15% whitespace margin, no text, no tagline, pure white background, readable at 64x64.
