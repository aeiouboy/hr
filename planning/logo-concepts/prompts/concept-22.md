...
Subject: A compass rose — simplified four-direction compass with a clean circular frame, thin directional needle pointing up-right (NE), and a small abstract person silhouette positioned at the exact center where the needle pivots. The compass reads as directional-guidance metaphor — "HR points you the right way / direction for talent."

Style: Flat vector illustration, naval-classic geometric but modern, enterprise SaaS with leadership/direction DNA. Confident and structured. Logo-mark quality.

Color palette: compass frame and ring in deep navy (#1E3A8A). Directional needle and cardinal marks in bright cyan (#0EA5E9). Center person in warm gold (#FBBF24) as the "North Star." Subtle background halo allowed in very pale cyan (#E0F2FE). Absolutely NO red, NO crimson.

Composition: compass centered, perfect radial symmetry, 15% whitespace margin, no text (no "N/S/E/W" letters — just dot marks or minimal tick indicators), no tagline, pure white background, readable at 64x64 favicon.
