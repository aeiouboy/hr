...
export type FieldType = 'string' | 'number' | 'date' | 'datetime' | 'boolean' | 'picklist' | 'multi-picklist';
/**
 ...
 */
export type FlowId = 'hire' | 'rehire' | 'transfer' | 'terminate' | 'contractRenewal' | 'probation' | 'empData';
