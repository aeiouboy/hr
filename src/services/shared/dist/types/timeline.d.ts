export type TimelineEventKind = 'hire' | 'probation_assess' | 'transfer' | 'terminate' | 'rehire' | 'contract_renewal' | 'promotion' | 'acting_start' | 'acting_end';
...
export type TimelineEvent = HireEvent | ProbationEvent | TransferEvent | TerminateEvent | RehireEvent | ContractRenewalEvent | PromotionEvent | ActingEvent;
