...
'flex items-center gap-3 px-4 py-2.5 rounded-md transition text-sm',
 ...
 <aside
 className={cn(
'hidden lg:flex flex-col bg-surface border-r border-hairline h-[calc(100vh-56px)] sticky top-14 transition-all duration-200',
 ...
 className="flex items-center justify-center py-3 border-t border-hairline hover:bg-surface-raised transition"
