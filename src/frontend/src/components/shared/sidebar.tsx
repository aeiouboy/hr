...
export function Sidebar() {
 ...
 return (
  <aside
   className={cn(
    'hidden lg:flex flex-col bg-surface h-[calc(100vh-56px)] sticky top-14 transition-all duration-200',
  ...
  >
   ...
   <button
    ...
    className="flex items-center justify-center py-3 mt-2 hover:bg-surface-raised transition rounded-md mx-2 mb-2"
