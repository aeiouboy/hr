...
'px-4 py-2 rounded-md text-sm font-medium border transition',
 ...
 :'border-hairline border-hairline text-ink-muted hover:border-hairline dark:hover:border-gray-600'
 )}
 >
 ...
 {/* Duration display */}
 {workingDays > 0 && (
 <div className="p-4 bg-surface-raised rounded-md">
 <p className="text-sm text-ink-muted">{t('duration')}</p>
