...
export function SettingsPage() {
 ...
 <tr key={policy.type} className="border-b border-hairline">
 ...
 <label key={item.key} className="flex items-center justify-between p-3 rounded-md hover:bg-surface-raised/50">
