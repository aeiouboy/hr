    ...
    >
      ...
      <div className="print:shadow-none print:p-0 font-serif">
        ...
        <div className="text-center border-b-2 border-gray-800 dark:border-gray-300 pb-4 mb-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-wide">
            {t('companyName')}
          </h1>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-0.5">เซ็นทรัล กรุ๊ป</p>
        ...
        <div className="text-center mb-6">
          <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 uppercase tracking-widest">
            {t('letterTitle')}
          </h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">หนังสือส่งตัวรักษาพยาบาล</p>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 italic">{t('letterSubtitle')}</p>
        </div>

        {/* Referral Number & Date */}
        <div className="flex justify-between text-sm mb-6">
          <div>
            <span className="text-gray-500 dark:text-gray-400">{t('referralNumber')}:</span>{' '}
        ...
        {/* Main content box */}
        <div className="border border-gray-300 dark:border-gray-600 rounded-lg p-6 space-y-4 bg-gray-50 dark:bg-gray-800/50 text-sm">
          {/* Employee info */}
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <p className="text-gray-500 dark:text-gray-400 text-xs">Employee Name</p>
                <p className="font-semibold text-gray-900 dark:text-gray-100">{referral.employeeName}</p>
              </div>
              <div>
                <p className="text-gray-500 dark:text-gray-400 text-xs">Employee ID</p>
                <p className="font-semibold text-gray-900 dark:text-gray-100">{referral.employeeId}</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <p className="font-semibold text-gray-900 dark:text-gray-100">{referral.hospitalName}</p>
              </div>
              {referral.hospitalBranch && (
                <div>
                  <p className="text-gray-500 dark:text-gray-400 text-xs">Branch</p>
                  <p className="font-semibold text-gray-900 dark:text-gray-100">{referral.hospitalBranch}</p>
                </div>
              )}
            </div>
          </div>
          ...
          {(referral.validFrom || referral.validUntil) && (
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {referral.validFrom && (
                  <div>
                    <p className="text-gray-500 dark:text-gray-400 text-xs">{t('validFrom')}</p>
                    <p className="font-semibold text-gray-900 dark:text-gray-100">{referral.validFrom}</p>
                  </div>
                )}
                {referral.validUntil && (
                  <div>
                    <p className="text-gray-500 dark:text-gray-400 text-xs">{t('validUntil')}</p>
                    <p className="font-semibold text-gray-900 dark:text-gray-100">{referral.validUntil}</p>
                  </div>
                )}
              </div>
            </div>
          ...
          {referral.amount && (
            <>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <p className="text-gray-500 dark:text-gray-400 text-xs">Authorized Amount</p>
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{referral.reason}</p>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-2 gap-8 text-sm">
          <div className="text-center">
            <div className="border-b border-gray-400 dark:border-gray-500 pb-1 mb-2 min-h-[48px]" />
