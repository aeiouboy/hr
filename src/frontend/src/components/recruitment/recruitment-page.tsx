              ...
              <CardContent className="p-5 sm:p-6 lg:p-8">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  ...
                  <div className="text-right">
                    <p className="text-sm text-gray-400 dark:text-gray-500">{t('closingDate')}: {job.closingDate}</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{job.applicationCount} applications</p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                    <th className="text-left py-3 px-4 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase">{t('candidate')}</th>
                    <th className="text-left py-3 px-4 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase">{t('position')}</th>
                    <th className="text-left py-3 px-4 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase">{t('appliedDate')}</th>
                    <th className="text-left py-3 px-4 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase">{t('source')}</th>
                    <th className="text-left py-3 px-4 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase">{t('status')}</th>
                    <th className="text-center py-3 px-4 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase"></th>
                  </tr>
                </thead>
                <tbody>
                  {candidates.map((c) => (
                    <tr key={c.id} className="border-b dark:border-gray-700 last:border-0 hover:bg-gray-50 dark:hover:bg-gray-700/30 cursor-pointer" onClick={() => setSelectedCandidate(c)}>
                      ...
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-400">{c.position}</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-400">{c.appliedDate}</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-400">{c.source}</td>
              ...
              <CardContent className="p-5 sm:p-6 lg:p-8">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-500 dark:text-gray-400">{job.applicationCount} apps</span>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        {selectedJob && (
          <div className="space-y-4">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-400">{selectedJob.department} - {selectedJob.location}</span>
            </div>
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div><span className="text-gray-400 dark:text-gray-500">{t('closingDate')}</span><p className="font-medium">{selectedJob.closingDate}</p></div>
            </div>
            <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">{selectedCandidate.email} | {selectedCandidate.phone}</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div><span className="text-gray-400 dark:text-gray-500">{t('positionApplied')}</span><p className="font-medium">{selectedCandidate.position}</p></div>
              <div><span className="text-gray-400 dark:text-gray-500">{t('experience')}</span><p className="font-medium">{selectedCandidate.experience}</p></div>
              <div><span className="text-gray-400 dark:text-gray-500">{t('source')}</span><p className="font-medium">{selectedCandidate.source}</p></div>
              <div><span className="text-gray-400 dark:text-gray-500">{t('status')}</span><Badge variant={STATUS_VARIANT[selectedCandidate.status]}>{selectedCandidate.status}</Badge></div>
            </div>
            <div>
