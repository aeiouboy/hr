      ...
      {editTarget && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" role="dialog" aria-modal="true" aria-label={`แก้ไข ${editTarget.label}`}>
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-1.5">ชื่อ (Label)</label>
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Icon (Lucide)</label>
